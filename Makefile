...
PYTHON      :=  python
SOURCES     :=  src src/GameObjects src/GameObjectComponents src/Map ./butanoEngine/common/src
INCLUDES    :=  include include/GameObjects include/GameObjectComponents include/Map ./butanoEngine/common/include
DATA        :=
