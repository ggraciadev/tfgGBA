...
PYTHON      :=  python
SOURCES     :=  src src/GameObjects src/GameObjectComponents src/Map src/GUI ./butanoEngine/common/src
INCLUDES    :=  include include/GameObjects include/GameObjectComponents include/Map scr/GUI ./butanoEngine/common/include
DATA        :=
