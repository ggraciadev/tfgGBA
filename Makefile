...
PYTHON      :=  python
SOURCES     :=  src src/GameObjects src/GameObjectComponents ./butanoEngine/common/src
INCLUDES    :=  include include/GameObjects include/GameObjectComponents ./butanoEngine/common/include
DATA        :=
