...
BUILD       :=  build
LIBBUTANO   :=  ./butanoEngine/butano
PYTHON      :=  python
SOURCES     :=  src src/GameObjects src/GameObjectComponents src/Map src/GUI src/Scenes ./butanoEngine/common/src
INCLUDES    :=  include include/GameObjects include/GameObjectComponents include/Map scr/GUI src/Scenes ./butanoEngine/common/include
DATA        :=
GRAPHICS    :=  graphics ./butanoEngine/common/graphics
AUDIO       :=  audio ./butanoEngine/common/audio
DMGAUDIO    :=  dmg_audio ./butanoEngine/common/dmg_audio
ROMTITLE    :=  ROM TITLE
ROMCODE     :=  SBTP
USERFLAGS   :=  
USERASFLAGS :=  
