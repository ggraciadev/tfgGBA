...
#define OFFSET_X - MAP_WIDTH * TILE_WIDTH / 2

#define OFFSET_Y + MAP_HEIGHT * TILE_HEIGHT / 2
...
public:
    ...
    MapCollisionType GetCollisionByCell(int cellX, int cellY) { return collisions[cellX + MAP_WIDTH * cellY]; }
